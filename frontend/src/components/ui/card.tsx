...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'ring-foreground/10 bg-card text-card-foreground group/card flex flex-col gap-6 overflow-hidden py-6 text-sm shadow-xs ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4',
        className,
      )}
      {...props}
    />
